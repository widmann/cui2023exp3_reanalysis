...
#### Model 1: SNR x cond ----
m1 <- pupil_area ~ snr_ctr * cond + (1 + cond | subj )
fm1 <- lmer(m1, data = dat,
...
m2 <- pupil_area ~ snr_ctr * cond + trial_ctr * cond + I(trial_ctr ^ 2) * cond + (1 + cond + trial_ctr + I(trial_ctr ^ 2) | subj)
